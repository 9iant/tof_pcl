...
private:
    void generateSensorPointCloud()
    {
        ...
        image_msg_->data.resize(image_msg_->width * image_msg_->height * sizeof(float));
        memcpy(image_msg_->data.data(), depth_ptr, image_msg_->width * image_msg_->height * sizeof(float));
    }
    void update()
    {
